...
\Title{Real-Time TECS Gain Tuning Using Steepest Descent Method for Post-Transition Stability in Tiltrotor eVTOLs}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/tiltrotor_gazebo.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \captionof{figure}{Specific Total Energy Rate Error}
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \captionof{figure}{Specific Balance Energy Rate Error}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \captionof{figure}{Pitch Setpoint Output}
